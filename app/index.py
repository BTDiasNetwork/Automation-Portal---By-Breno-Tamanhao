...
with st.sidebar:
    ...
    st.write(f"**Usuario:** {usuario_info['usuario']}")
...
st.markdown("<h1 style='text-align: center;'>🚀 Portal de Automacao</h1>",
            unsafe_allow_html=True)
st.markdown(
...
st.write(f"**Progresso:** {etapas_completas}/6 etapas concluidas")
st.markdown("---")
